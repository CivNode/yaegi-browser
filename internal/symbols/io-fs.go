...
func (W _io_fs_ReadLinkFS) Lstat(name string) (fs.FileInfo, error) {
	return W.WLstat(name)
}
func (W _io_fs_ReadLinkFS) Open(name string) (fs.File, error) {
	return W.WOpen(name)
}
func (W _io_fs_ReadLinkFS) ReadLink(name string) (string, error) {
	return W.WReadLink(name)
}
